...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function showQuestion() {
        ...
        currentQuestion.options.forEach(optionText => {
            ...
            button.className = "option-btn w-full p-4 bg-gray-700 rounded-lg text-left text-lg hover:bg-gray-600 transition-colors duration-300 disabled:opacity-50 disabled:cursor-not-allowed";
    ...
    function selectAnswer(selectedButton, selectedOption, correctAnswer) {
        ...
        if (selectedOption === correctAnswer) {
            ...
            // Remove classes de hover e adiciona a classe de acerto
            selectedButton.classList.remove('hover:bg-gray-600');
            ...
            // Remove classes de hover e adiciona a classe de erro
            selectedButton.classList.remove('hover:bg-gray-600');
